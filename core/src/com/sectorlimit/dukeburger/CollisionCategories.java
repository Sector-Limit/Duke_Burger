...
public class CollisionCategories {
	...
	public static final short ENEMY_SENSOR     = 1 << 5;
	public static final short ENEMY_BOUNDARY   = 1 << 6;
	public static final short BURGER           = 1 << 7;
	public static final short DOOR             = 1 << 8;
	public static final short PROJECTILE       = 1 << 9;
