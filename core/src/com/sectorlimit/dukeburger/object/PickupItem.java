...
public abstract class PickupItem {
	...
	public void render(SpriteBatch spriteBatch) {
		...
		spriteBatch.draw(m_texture, renderOrigin.x, renderOrigin.y + 1, getSize().x / 2, getSize().y / 2, m_texture.getWidth(), m_texture.getHeight(), 1.0f, 1.0f, (float) Math.toDegrees(m_body.getAngle()), 0, 0, m_texture.getWidth(), m_texture.getHeight(), false, false);
	}
